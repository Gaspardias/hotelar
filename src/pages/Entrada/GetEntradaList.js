        ...
        <LoadingMessage></LoadingMessage>
          ...
          <TableContainer component={Paper}>
            <Paper component="div" sx={{display:"flex"}}>
              <Box component="div">
                <Button variant="contained" color="primary" onClick={goTo} sx={{minHeight:"3.5rem", margin:"0.5rem"}}>
                  Nova Entrada <Add />
                </Button>
              </Box>
              <Box component="div" sx={{display:"flex", marginLeft:"auto"}}>
                ...
                {({ errors, touched }) => (
                  <Form >
                    ...
                    <Button type="submit" variant="contained" sx={{minHeight:"3.5rem", margin:"0.5rem"}}>
                        PROCURAR <Search />
                    </Button>
                  </Form>
                )}

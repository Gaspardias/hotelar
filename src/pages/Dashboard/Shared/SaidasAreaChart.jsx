...
const SaidasAreaChart = ({ data }) => {
  ...
  useEffect(() => {
    ...
    const formattedData = data.map(item => ({
      date: format(new Date(item.Data), 'dd/MM/yyyy'),
  ...
  return (
    <Card>
      <CardHeader sx={{ textAlign: "center" }} title="SAIDAS" />
      <Box component="div" ref={chartRef} sx={{ width: '1200px', height: '250px', marginBottom:"1rem"}} />
    </Card>
  )
};

export default SaidasAreaChart;
